...
export const normalizeAdminLocation = (item: AdminLocationApiRecord): LocationRecord => ({
...
export default function LocationsManager({
  compactHeader = false,
  heading = "Locations",
  description = "Configure pickup/delivery locations used in monthly checkout flow."
    ...
    <section className="space-y-7">
      {!compactHeader ? (
        <div>
          ...
          <h2 className="mt-1 text-3xl font-semibold text-white">{heading}</h2>
